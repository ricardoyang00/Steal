...
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Aetherium Chronicles', 'Pitcher throws a no-hitter', 12, 151.65, 95, 19, true, '2022-02-02');
