...
-- GAME
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Stormborn Alliance', 'Rain delay postpones game', 3, 110.53, 33, 11, true, '2021-03-15');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Spectral Knights', 'Controversial call decides the outcome', 5, 21.63, 6, 14, true, '2020-07-22');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Rogue Galaxy', 'Pitcher throws a no-hitter', 6, 59.65, 47, 11, true, '2022-01-10');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Reckoning of Kings', 'Team hits 5 home runs in a single game', 13, 69.55, 82, 15, true, '2021-11-05');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Arcane Rivals', 'Controversial call decides the outcome', 2, 43.35, 6, 16, true, '2020-05-18');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Quantum Surge', 'Pitcher throws a no-hitter', 15, 195.09, 27, 12, true, '2021-09-30');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Echoes of Eternity', 'Exciting comeback win in extra innings', 4, 24.09, 24, 11, true, '2022-04-25');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Steel Vanguard', 'Rain delay postpones game', 7, 156.87, 73, 15, true, '2021-06-12');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Lost Horizon', 'Controversial call decides the outcome', 15, 134.84, 18, 11, true, '2020-08-19');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Lost Horizon', 'Pitcher throws a no-hitter', 12, 22.36, 3, 11, true, '2021-02-14');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Arcane Rivals', 'Controversial call decides the outcome', 1, 128.95, 2, 13, true, '2022-03-07');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Stellar Depths', 'Rain delay postpones game', 4, 159.58, 56, 12, true, '2021-12-20');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Stormborn Alliance', 'Rain delay postpones game', 11, 199.81, 84, 17, true, '2020-11-11');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Project Genesis', 'Exciting comeback win in extra innings', 2, 175.92, 3, 11, true, '2022-05-03');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Phantom Abyss', 'Rain delay postpones game', 17, 101.03, 9, 13, true, '2021-07-27');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Stellar Depths', 'Controversial call decides the outcome', 13, 14.36, 7, 15, true, '2020-09-09');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Nova Odyssey', 'Exciting comeback win in extra innings', 15, 127.09, 23, 16, true, '2021-04-01');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Solar Strike', 'Controversial call decides the outcome', 17, 171.03, 9, 16, true, '2022-02-18');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Soulbound Warriors', 'Rain delay postpones game', 1, 36.92, 30, 15, true, '2020-06-05');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Reckoning of Kings', 'Team hits 5 home runs in a single game', 0, 58.93, 56, 20, true, '2021-10-23');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Empire of Shadows', 'Pitcher throws a no-hitter', 13, 18.07, 13, 17, true, '2020-12-30');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Empire of Shadows', 'Rain delay postpones game', 2, 37.12, 14, 15, true, '2021-08-15');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Lost Horizon', 'Controversial call decides the outcome', 7, 151.31, 57, 19, true, '2022-03-29');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Celestial Order', 'Exciting comeback win in extra innings', 0, 146.36, 59, 12, true, '2020-10-17');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Veil of Shadows', 'Pitcher throws a no-hitter', 12, 138.47, 6, 18, true, '2021-05-21');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Vortex Assault', 'Team hits 5 home runs in a single game', 0, 110.9, 4, 15, true, '2022-01-05');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Titanfall Eclipse', 'Team hits 5 home runs in a single game', 8, 83.41, 58, 11, true, '2020-07-01');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Iron Rebellion', 'Exciting comeback win in extra innings', 16, 133.58, 8, 12, true, '2021-11-30');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Soulbound Warriors', 'Team hits 5 home runs in a single game', 18, 41.92, 11, 15, true, '2022-04-11');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('War of Realms', 'Exciting comeback win in extra innings', 16, 120.12, 45, 13, true, '2020-09-25');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Reckoning of Kings', 'Controversial call decides the outcome', 17, 57.23, 9, 16, true, '2021-06-18');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Aetherium Chronicles', 'In the ancient realm of Aetherium, a land of floating islands, mystical creatures, and powerful elemental magic, the balance of power is held by the Celestial Crown—a legendary artifact said to grant its wearer control over all the elements. For centuries, the crown has kept peace among the five Elemental Kingdoms: Fire, Water, Earth, Air, and Light.  But when the crown is shattered into five pieces by a betrayal from within, chaos erupts across the lands. The once-united kingdoms are plunged into war, each vying for control of the pieces. Amidst the turmoil, a prophecy emerges: a group of unlikely heroes, each from a different kingdom, must unite to restore the crown and bring peace back to Aetherium.  Main Characters:  Kael Emberstone - A fiery and stubborn blacksmiths apprentice from the Fire Kingdom, Kael discovers he has the rare ability to forge with elemental fire. Liora Tidewalker - A calm and resourceful healer from the Water Kingdom, Liora is haunted by visions of the future and a past she cannot remember. Aric Stonebreaker - A stoic warrior from the Earth Kingdom with a mysterious connection to the land, who seeks revenge for the destruction of his village. Sera Windwhisper - A free-spirited thief from the Air Kingdom, Sera is skilled in the art of deception and has a hidden agenda of her own. Elyon Lightbringer - A scholar and mage from the Light Kingdom, Elyon is determined to uncover the secrets of the Celestial Crown and prove his worth to a father who never believed in him.', 12, 151.65, 95, 19, true, '2022-02-02');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Eclipse Rising', 'Rain delay postpones game', 14, 101.05, 82, 13, true, '2020-11-27');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Solar Strike', 'Pitcher throws a no-hitter', 13, 157.48, 36, 18, true, '2021-08-03');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Iron Frontier', 'Exciting comeback win in extra innings', 6, 8.45, 86, 17, true, '2022-05-19');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Nova Odyssey', 'Rain delay postpones game', 0, 144.74, 89, 13, true, '2021-03-02');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Soulbound Warriors', 'Pitcher throws a no-hitter', 12, 56.79, 36, 19, true, '2020-06-28');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Mecha Legacy', 'Rain delay postpones game', 0, 75.18, 88, 19, true, '2021-12-08');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Veil of Shadows', 'Controversial call decides the outcome', 9, 8.79, 0, 11, true, '2022-01-21');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Project Genesis', 'Rain delay postpones game', 0, 166.01, 21, 19, true, '2020-10-03');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Eternal Nexus', 'Controversial call decides the outcome', 5, 156.04, 91, 11, true, '2021-04-14');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Fallen Stars', 'Controversial call decides the outcome', 8, 154.81, 34, 13, true, '2022-03-12');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Soulbound Warriors', 'Exciting comeback win in extra innings', 13, 18.43, 45, 20, true, '2020-07-14');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Quantum Surge', 'Team hits 5 home runs in a single game', 14, 185.58, 42, 14, true, '2021-09-05');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Iron Rebellion', 'Exciting comeback win in extra innings', 4, 92.56, 30, 17, true, '2022-05-27');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Kingdoms at War', 'Pitcher throws a no-hitter', 6, 85.75, 52, 14, true, '2020-08-23');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Veil of Shadows', 'Pitcher throws a no-hitter', 1, 101.17, 97, 14, true, '2021-10-09');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Astral Boundaries', 'Rain delay postpones game', 2, 116.29, 74, 11, true, '2022-02-25');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Solar Strike', 'Exciting comeback win in extra innings', 4, 55.51, 3, 14, true, '2020-12-01');
insert into Game (name, description, minimum_age, price, overall_rating, owner, is_active, release_date) values ('Galactic Forge', 'Exciting comeback win in extra innings', 0, 56.69, 0, 18, true, '2020-12-01');
